...
use ort::{
    ...
    session::{builder::GraphOptimizationLevel, SessionInputs, Session, SessionInputValue},
...
impl Engine {
    ...
    fn build_session(
        ...
        {
            tracing::info!(
                "Disabling ort graph optimization for TensorRT. `ort_graph_opt_level` setting is ignored."
            );
            builder = builder
